...
export default function DashboardShell({
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: "'Inter',sans-serif", background: c.bg, position: 'relative' }}>
      ...
      {/* ── Main Panel ── */}
      <div style={{ marginLeft: sidebarW, flex: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh', transition: 'margin-left 0.25s ease', zIndex: 5, minWidth: 0, maxWidth: `calc(100vw - ${sidebarW}px)` }}>
        ...
        {/* Page content */}
        <div className="dash-content" style={{ flex: 1, padding: 24, minWidth: 0, maxWidth: '100%', boxSizing: 'border-box' }}>
          {children}
        </div>
