    ...
    <form onSubmit={handleSubmit} className={\`p-6 rounded-2xl shadow-sm mb-6 flex flex-col md:flex-row gap-4 \${isDark ? 'bg-gray-800' : 'bg-white'}\`}>
      <div className="flex-1 relative">
        ...
        <input 
          ...
          className={\`w-full pl-12 pr-4 py-4 rounded-xl text-lg font-mono font-bold tracking-widest \${isDark ? 'bg-gray-900 text-white border-gray-700' : 'bg-gray-50 text-gray-900 border-gray-300'} border focus:outline-none focus:ring-2 focus:ring-[#d4af37]\`}
          value={code}
